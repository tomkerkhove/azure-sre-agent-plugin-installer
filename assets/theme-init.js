...
// Content-Security-Policy meta tag, which only covers content that follows
// it), ahead of assets/style.css and assets/app.js: without it, the page
// renders with the default light theme baked into
// index.html/install.html's markup, and only switches to the requested
// theme once assets/app.js runs on `DOMContentLoaded` - after the
...
(function () {
  ...
  // this file and destructures its `module.exports` directly instead.
